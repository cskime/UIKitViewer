...
class SliderCell: UITableViewCell {
    ...
    private func setupConstraints() {
        let subviews = [self.nameLabel, self.slider, self.countLabel]
        subviews.forEach {
        ...
        NSLayoutConstraint.activate([
            ...
            self.countLabel.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: -UI.paddingY * 2),
            self.countLabel.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: -UI.paddingX),
            self.countLabel.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -UI.paddingY),
    ...
    func configureContents(title: String, count: Int) {
